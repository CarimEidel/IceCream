      ...
      <table id="table_id" class="display">
         ...
         <thead>
            ...
            try {
                ...
                String sql = "SELECT prod.*, sell.seller_name FROM ecommerce.products AS prod LEFT JOIN ecommerce.seller as sell ON sell.seller_id = prod.seller_id where prod.status = 'Pending'";
